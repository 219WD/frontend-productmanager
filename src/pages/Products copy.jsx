...
//     // Función para abrir/cerrar el modal y obtener el último vencimiento al abrirlo
//     const handleModal = () => {
...
//     // Función para abrir y cerrar el modal de agregar productos
//     const handleShow = () => setLgShow(true);
//     const handleClose = () => setLgShow(false);

//     // Función para abrir y cerrar el modal de editar productos
//     const handleShowEditModal = () => setShowEditModal(true);
//     const handleCloseEditModal = () => setShowEditModal(false);

//     const handleOpenModal = () => {
//         setLgShow(true);
//         // Llama a la función para obtener los últimos campos seleccionados
//         getLastFields();
//     };
...
//     const handleEditClick = (vencimientoId) => {
//         setEditingVencimientoId(vencimientoId);
//         setShowModal(true); // Mostrar el modal para editar el vencimiento seleccionado
//     };
...
//                         </Modal.Body>
//                         <div className='modalfooter'>
//                             <Button className='btn-solid' variant="secondary" onClick={handleCloseEditModal}>
//                                 Cancelar
//                             </Button>
